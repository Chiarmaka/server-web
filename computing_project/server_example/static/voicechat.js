...
easyrtc.setAcceptChecker(function(easyrtcid, callback) {
    ...
    //if( easyrtc.getConnectionCount() > 0 ) {
       // document.getElementById('acceptCallLabel').textContent = "decline current call and accept new from " + easyrtcid + " ?";
   // }
    //if {
       // document.getElementById('acceptCallLabel').textContent = "Accept incoming call from " + easyrtcid + " ?";
    //}
    document.getElementById('acceptCallLabel').textContent = "Accept incoming call";
